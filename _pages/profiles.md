...
<div class="profile float-right">
  <img
    ...
    alt="Lab activities collage"
    loading="eager"
    data-zoom-group="current-research-group"
    data-zoom-title="Lab activities in computational neuroscience and bioinspired robotics"
  >
...
<div class="profile float-right">
  <div id="mariel-research-carousel" class="carousel slide research-carousel z-depth-1" data-ride="carousel" data-interval="false">
    <ol class="carousel-indicators">
      ...
      <li data-target="#mariel-research-carousel" data-slide-to="2"></li>
      <li data-target="#mariel-research-carousel" data-slide-to="3"></li>
    </ol>
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img
          src="{{ '/assets/img/research-group/fm_lab/lab_fm_1.jpeg' | relative_url }}"
          class="d-block w-100 teaching-zoomable"
          alt="UNR-CRH linkage project with Dr. Mariel E. Galassi"
          loading="lazy"
          data-zoom-group="previous-research-ifir"
          data-zoom-title="UNR-CRH linkage project with Dr. Mariel E. Galassi."
        >
      </div>
      <div class="carousel-item">
        <img
          src="{{ '/assets/img/research-group/fm_lab/lab_fm_2.jpeg' | relative_url }}"
          class="d-block w-100 teaching-zoomable"
          alt="Working in the Fisica Biomedica laboratory"
          loading="lazy"
          data-zoom-group="previous-research-ifir"
          data-zoom-title="Working in the Fisica Biomedica laboratory at IFIR."
        >
      </div>
      <div class="carousel-item">
        <img
          src="{{ '/assets/img/research-group/fm_lab/poster_fm.jpeg' | relative_url }}"
          class="d-block w-100 teaching-zoomable"
          alt="Poster presentation at AFA 107"
          loading="lazy"
          data-zoom-group="previous-research-ifir"
          data-zoom-title="Presenting a poster with Dr. Analia I. Alet at AFA 107: Preliminary Study of the Viscoelastic Properties of Red Blood Cells Irradiated with Gamma Radiation Using a Rheometer."
        >
      </div>
      <div class="carousel-item">
        <img
          src="{{ '/assets/img/research-group/fm_lab/rheometer.png' | relative_url }}"
          class="d-block w-100 teaching-zoomable"
          alt="Erythrocyte rheometer setup"
          loading="lazy"
          data-zoom-group="previous-research-ifir"
          data-zoom-title="Erythrocyte rheometer at the Fisica Biomedica laboratory, IFIR."
        >
      </div>
    </div>
    <a class="carousel-control-prev" href="#mariel-research-carousel" role="button" data-slide="prev" aria-label="Previous slide">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="sr-only">Previous</span>
    </a>
    <a class="carousel-control-next" href="#mariel-research-carousel" role="button" data-slide="next" aria-label="Next slide">
      <span class="carousel-control-next-icon" aria-hidden="true"></span>
      <span class="sr-only">Next</span>
    </a>
  </div>
